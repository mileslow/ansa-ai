# Authoritative content references

These sources are authoritative for terminology or regulatory/tax background,
not pre-approved employer booklet copy and not proof of an employer's plans.
...
Original source URLs and verification are retained in
`source-docs/_provenance-catalogs/04_approved-language-patterns.md`.
